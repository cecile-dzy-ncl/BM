$(document).ready(function () {
  ...
  if ($("body").hasClass("homepage")) {
    var nombreEnfants = Math.floor(
      parseInt($(".nb_enfants span").html().replace(/ /g, "").split("€")[0]) / 2
    );
  ...
  $(".section-home-projects").prepend(
    "<h2>Exemples de campagnes en cours</h2>"
  );

  // AJOUT INTRO PAGE EVENTS
  var textIntroEvents =
    "<div class='container-small-bm mt-50'><h2>Deux minutes suffisent pour créer votre collecte.</h2></div>";
  $(".events .first-section").before(textIntroEvents);

  // AJOUT INTRO PAGE PROJETS
  var textIntroProjects =
    "<div class='container-small-bm mt-50'><h2>Retrouver et soutenir une collecte</h2></div>";
  ...
  $("a.popup-video").magnificPopup({
    items: {
      src: "https://www.youtube.com/watch?v=eMZYvakTcxY",
    },
    type: "iframe",
    iframe: {
      markup:
