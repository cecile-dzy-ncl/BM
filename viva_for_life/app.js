$(document).ready(function () {
  ...
  $("#events-show .habillage").prepend(
    '<div class="stats-event mobile_flex-column"><div class="stats-event-2"><div class="stats-event-montants mobile_flex-column"><div class="stats-event-m-1"><span>97 560 €</span> collectés</div><div class="stats-event-m-2">Objectif: <span>100 000 €</span></div></div><div class="progress"><span class="graph-barBack"><span class="graph-bar" data-value="10"></span></span></div></div></div></div>'
  );
  ...
  $(function () {
    if ($("body").is("#events-show") && !$("body").hasClass("event_5")) {
      ...
      if (
        $(".current-amount").html().split("     ")[1].split(" €")[0].length > 5
      ) {
        $(".enfants").html(
          Math.floor(
            Number.parseInt(
              $(".current-amount").html().split("     ")[1].split(" €")[0],
              10
            ) / 12
          )
        );
